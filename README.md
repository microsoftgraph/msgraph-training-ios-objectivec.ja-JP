# <a name="microsoft-graph-training-module---build-ios-native-apps-with-objective-c-and-the-microsoft-graph-sdk"></a>Microsoft Graph トレーニングモジュール-目的-C と Microsoft Graph SDK を使用して iOS ネイティブアプリをビルドする
